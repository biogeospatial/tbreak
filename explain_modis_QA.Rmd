...
res = modis_qa_explain (value)

#  There will be a tidyverse way of doing this.
len = max(stri_length(names(res)))
fmt = paste0("%-", len, "s: %s")
i = 0
o = character()
for (name in names(res)) {
  i = i + 1
  o1 = sprintf (fmt, name, res[[name]])
  o[i] = o1
}
o
